...
class CompanySpider(scrapy.Spider):
    ...
    def parse_company(self, response: scrapy.Request):
        ...
        company["IndustryShortCode"] = data["udvidedeOplysninger"]["hovedbranche"]["branchekode"][:2]
        company["IndustryGroup"] = None
        ...
        company["DirectorAddressLatitude"] = None
        company["DirectorAddressLongitude"] = None
        company["BusinessAddressLatitude"] = None
        company["BusinessAddressLongitude"] = None
